package net.nathan.gandlsmod.worldgen.biome.surface;
...
public class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource SAPPHIRE = makeStateRule(Blocks.STONE);
    private static final SurfaceRules.RuleSource RAW_SAPPHIRE = makeStateRule(Blocks.STONE);
