...
public class WarlockStickItem extends Item {
    public WarlockStickItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        pPlayer.getAttribute(Attributes.MAX_HEALTH).setBaseValue(26.00f);
